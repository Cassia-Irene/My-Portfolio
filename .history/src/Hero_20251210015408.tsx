...
const Hero = () => {
  ...
  useEffect(() => {
    const calc = () => {
      ...
      if (w < 480) setOriginOffset(0.55);     // mobile pequeno -> empurra a origem pra baixo mais (menos negativo)
      else if (w < 768) setOriginOffset(0.45); // tablet pequeno
  ...
  return (
    <HeroSection id="section-00">
      ...
      <div
        ...
        top-100 md:top-0
        max-sm:top-100
        max-[480px]:top-[1000px]

        h-[140vh] md:h-full
        md:opacity-80 sm:opacity-60 max-sm:opacity-40"
        >
