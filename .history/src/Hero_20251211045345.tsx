      ...
      <div className="flex flex-col">
        ...
        <h1
          className="
            ...
            2xl:text-[120px] 2xl:tracking-[8px]
            xl:text-[100px] xl:tracking-[6px]
            text-[120px]
        ...
        <div
          className="
            ...
            relative
            2xl:mt-[-51px] xl:mt-[-48px]
            max-[1024px]:left-0 max-[1024px]:mt-[-40px]
            max-[768px]:justify-center max-[768px]:mt-[-20px]
          "
        >
          <div className="2xl:w-[132px] xl:w-[110px] h-[4px] bg-[#FFBB1B]" />
          <h2
            className="
              text-white font-['Racing_Sans_One']
              2xl:text-[90px] 2xl:tracking-[4px]
              xl:text-[75px] xl:tracking-[3px]
        ...
        <button
          ...
          className="
            relative 2xl:px-20 xl:px-16
            flex items-center
            w-auto
            bg-transparent border-none cursor-pointer
            text-[#FFBB1B] font-inter font-medium 
            2xl:text-[25px] xl:text-[24px]
