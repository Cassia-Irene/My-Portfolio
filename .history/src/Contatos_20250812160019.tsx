...
const SocialButton = styled.a< { 
  ...
  height: 56px;
  border-radius: 50%;
  background-color: ${({ centerBg }) => centerBg || 'transparent'};
  ...
  &:hover {
    ...
    ${({ hoverColor }) =>
      hoverColor.includes('linear-gradient')
        ? `
          border-color: transparent; /* esconde a borda sólida */
          &::before {
     ...
     <SubtitleWrapper>
      ...
      <Text>
        ...
        <SocialButton
          ...
          centerBg="linear-gradient(90deg, #FEC053 0%, #F2203E 33%, #B729A8 65%, #5342D6 100%)"
        >
