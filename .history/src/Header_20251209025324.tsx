      ...
      ">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="hidden md:block bg-[#FFBB1B] text-[#FFF] px-4 py-2 rounded-xl font-bold hover:bg-yellow-500 transition"
          >
          ...
          <button
            onClick={() => setLang(lang === "PT" ? "EN" : "PT")}
            className="md:hidden bg-[#FFBB1B] text-[#FFF] px-3 py-1.5 rounded-lg font-bold hover:bg-yellow-500 transition"
          >
            <IoLanguage className="text-xl" />
            {lang === "PT" ? "EN" : "PT"}
          </button>
