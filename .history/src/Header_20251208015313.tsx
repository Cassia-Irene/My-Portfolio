  ...
  return (
    <>
      ...
      <StarBorder
        ...
        color="cyan"
        speed="5s"
        className="fixed top-10 left-1/2 -translate-x-1/2 z-10
                          h-[60px] w-[60%] max-w-[650px]
                          flex justify-center items-center transition-all duration-300
                          max-md:hidden"
      >
        <header className="w-full h-full flex justify-center items-center"> {/* Oculta no mobile/tablet */}
