...
<div className="relative md:hidden">
  <StarBorder
    ...
    speed="4s"
    thickness={3}
    className="top-[90px] left-5 w-[100%] max-w-[330px] z-[1004]"
  >
    <motion.ul
      initial="closed"
    ...
    >
      ...
      <motion.li variants={itemVariants}>
        <a
          ...
          className="block text-center px-3 py-2 py-0.5 bg-[#FFBB1B] text-[#00171F] font-racing rounded-lg hover:bg-yellow-600 transition text-sm"
        >
