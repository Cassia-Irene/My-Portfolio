  ...
  return (
    <>
      ...
      <StarBorder
        ...
        color="cyan"
        speed="4s"
        className="fixed top-12 left-1/2 -translate-x-1/2 z-10 w-[60%] max-w-[620px] "
      >
              ...
              {navItems.map((item) => (
                <li key={item.id}>
                  <a
                    ...
                    className="text-white font-racing text-lg hover:opacity-100 hover:text-[#FFBB1B] transition-all duration-300"
                  >
                    {item.name}
                  </a>
                </li>
