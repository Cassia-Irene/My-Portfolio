  ...
  return (
    <SectionSkills id="section-02">
        ...
        <GridWrapper>
          ...
          <GridRow>
            <SkillImage src="/src/assets/svg_skills1.svg" alt="HTML" />
            <SkillImage src="/src/assets/svg_skills2.svg" alt="CSS" />
            <SkillImage src="/src/assets/svg_skills3.svg" alt="JavaScript" />
          </GridRow>
          <GridRow>
