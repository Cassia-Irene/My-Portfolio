...
const SocialButton = styled.a< { 
  ...
  height: 56px;
  border-radius: 50%;
  background-color: ${({ centerBg }) => centerBg || 'transparent'};background-color: transparent;
...
/* Pseudo-elemento para a borda gradiente no hover */
  &::before {
    content: '';
    position: absolute;
    inset: 0;
  ...
  &:hover {
    border-color: transparent; /* esconde borda branca */
  }

  &:hover::before {
    background: ${({ hoverColor }) => hoverColor.includes('linear-gradient') ? hoverColor : 'transparent'};
  }
     ...
     <SubtitleWrapper>
      ...
      <Text>
        <p>Tem um novo projeto em mente? Ou quer apenas dizer oi? Estou disponível para conversar e responder suas perguntas.</p>
            ...
            <SocialWrapper>
        <SocialButton
          href="https://wa.me/5598987378650"
          target="_blank"
        ...
        <SocialButton
          href="mailto:cassiairene14@gmail.com"
        ...
        <SocialButton
          href="https://linkedin.com/in/cassia-irene"
          target="_blank"
          rel="noopener noreferrer"
          hoverColor="#0074B6"
          centerBg="#00669C"
