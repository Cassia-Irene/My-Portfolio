  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-12 right-16 text-white text-lg font-bold z-[1002] 
                   hover:text-[#00e1ff] transition-all duration-300
                   md:right-10 sm:hidden"
      >
        {lang === "pt" ? "EN" : "PT"}
      </button>
      ...
      <div className="fixed top-8 right-5 flex items-center gap-4 z-[1002] md:hidden">
        ...
        <button
          onClick={toggleLanguage}
          className="text-white text-xl font-bold hover:text-[#00e1ff] transition-all"
        >
          {lang === "pt" ? "EN" : "PT"}
        </button>
