...
const SocialButton = styled.a< { 
  ...
  &:hover {
      border-color: transparent; /* Remove borda original */
      box-shadow: 0 0 10px ${({ borderBg }) => borderBg};

      &::after {
        background: ${({ borderBg }) => borderBg};
      }

      &::before {
        background: ${({ centerBg, borderBg }) => centerBg || borderBg};
      }
    }
