...
const StarBorder = <T extends React.ElementType = 'div'>({
  ...
  return (
    ...
    >
      ...
      <div
        className="
          relative z-1 bg-[##00171F] border border-gray-700 shadow-xl backdrop-blur-2xl md:bg-[#FFF]/20 md:backdrop-blur-xl md:shadow-xl md:border-black text-white 
          md:text-[16px] py-[8px] px-[13px] md:py-[16px] md:px-[26px] 
