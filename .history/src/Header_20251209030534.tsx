    ...
    <>
      ...
      ">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={() => setLang(lang === "PT" ? "EN" : "PT")}
            className="md:hidden flex items-center gap-2 bg-[#FFBB1B] text-[#00171F] text-base px-1 py-1.5 rounded-lg font-bold hover:bg-yellow-500 transition"
          >
            <IoLanguage className="text-md" />
            {lang === "PT" ? "PT" : "EN"}
          </button>
