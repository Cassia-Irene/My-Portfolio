...
<div className="relative md:hidden">
  <StarBorder
    ...
    color="cyan"
    speed="4s"
    className="absolute right-6 top-[90px] w-[100%] max-w-[365px] bg-[#FFF]/20 backdrop-blur-xl shadow-xl border-black rounded-xl overflow-hidden p-3 flex flex-col gap-3 z-[1004]"
  >
    <motion.ul
      initial="closed"
      ...
      style={{ originY: "top" }}
      className="
        bg-[#FFF]/20 backdrop-blur-xl shadow-xl border-black
      ...
      {navItems.map((item) => (
        <motion.li key={item.id} variants={itemVariants}>
          <button
            ...
            className="text-white font-racing text-base w-full text-left hover:text-[#00e1ff]"
          >
            {item.name}
          </button>
        </motion.li>
