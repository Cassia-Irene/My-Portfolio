    ...
    <>
      ...
      ">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={() => setLang(lang === "PT" ? "EN" : "PT")}
            className="md:hidden flex items-center gap-1 bg-[#FFBB1B] text-[#00171F] text-sm px-2.5 py-1.5 rounded-lg font-bold hover:bg-yellow-500 transition"
          >
...
<motion.button
  ...
  className="md:hidden relative h-7 w-7 flex flex-col justify-between items-center px-1.5 py-1.5"
>
  <motion.span
    variants={{
      open: { rotate: 45, y: 6 },
  ...
  />
      ...
      <div className="relative md:hidden">
        ...
        <motion.ul
          ...
          className="
            absolute top-[90px]
            inset-x-6 max-w-[375px] bg-[#FFF]/20
