...
import CardNav from './components/CardNav' // ajuste o caminho se necessário
  ...
  return (
    <header className="relative z-100">
      <CardNav
        logo="/logo.svg"
        items={navItems}
        baseColor="rgba(0,0,0,0.3)" // fundo semi-transparente
        menuColor="#fff"            // cor do hamburger
        buttonBgColor="#FFBB1B"     // cor do botão interno "Get Started" caso exista
        buttonTextColor="#000"
        className="rounded-[50px] backdrop-blur-md shadow-lg mt-2" // oval + blur
      />
    </header>
  )
}
