      ...
      ">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="md:hidden text-[#FFBB1B] relative z-10 text-2xl"
          >
...
<div className="relative md:hidden">
  <StarBorder
    ...
    speed="4s"
    thickness={4}
    className="absolute top-full right-0 mt-24 w-[200px] z-[1004]"
  >
    <motion.ul
      initial="closed"
      ...
      style={{ originY: "top" }}
      className="flex flex-col gap-3 p-3 bg-[#FFF]/20 backdrop-blur-xl shadow-xl border-black rounded-xl"
    >
      {navItems.map((item) => (
