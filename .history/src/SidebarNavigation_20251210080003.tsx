...
const SidebarNavigation = () => {
  ...
  return (
    <div className="hidden lg:flex fixed top-[38%] right-8 z-[1000] w-[50px]">

      {/* WRAPPER PRINCIPAL */}
      <div className="relative flex h-[270px]">

        {/* Linha */}
        <div className="w-[1.5px] h-full bg-[#FFBB1B] absolute left-[25px]" />
        ...
        {/* Dots */}
        <div className="flex flex-col gap-0 relative right-[40px]">
