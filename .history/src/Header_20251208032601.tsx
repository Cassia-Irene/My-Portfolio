  ...
  return (
    <>
      ...
      <StarBorder
        ...
        color="#FFBB1B"
        speed="6s"
        className="fixed top-10 left-1/2 -translate-x-1/2 z-10 w-[60%] max-w-[650px] rounded-full max-md:hidden"
      >
        <header
          className="relative bg-[#fff]/20 backdrop-blur-xl shadow-xl rounded-full h-[60px] p-2 flex justify-center items-center"
        >
          <nav className="flex">
              ...
              {navItems.map((item) => (
                <li key={item.id}>
                  <a
                    ...
                    className="text-white font-inter font-medium text-lg opacity-80 hover:opacity-100 hover:text-[#FFBB1B] transition-all duration-300"
                  >
                    {item.name}
                  </a>
                </li>
