  ...
  return (
    <SectionSkills id="section-02">
        ...
        <GridWrapper>
          ...
          <GridRow>
            <SkillImage src={skills1} alt="CSS 3" />
            <SkillImage src={skills2} alt="Figma" />
            <SkillImage src={skills3} alt="HTML 5" />
          </GridRow>
          <GridRow>
          ...
          <GridRow>
            <SkillImage src={skills4} alt="Python" />
            <SkillImage src={skills5} alt="Figma" />
            <SkillImage src={skills6} alt="Visual Studio" />
          </GridRow>
          <GridRow>
