  ...
  return (
    <SectionSkills id="section-02">
        ...
        <TextContent>
          ...
          <p>Visite meu <LinkedinLink href="https://www.linkedin.com/in/seu-usuario" target="_blank" rel="noopener noreferrer">Linkedin</LinkedinLink> para mais detalhes.</p>
