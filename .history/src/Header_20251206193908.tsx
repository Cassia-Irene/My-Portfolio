  ...
  return (
    <>
      ...
      <img
        src={LogoImg}
        alt="Logo"
        className="fixed top-4 left-4 z-50 w-24 h-20 sm:w-20 sm:h-16 xs:w-16 xs:h-14"
      />
      ...
      <header className="fixed top-4 left-1/2 transform -translate-x-1/2 w-3/5 max-w-lg bg-white/20 backdrop-blur-lg rounded-2xl shadow-md flex justify-center items-center h-16 sm:w-4/5 sm:flex-col sm:h-auto sm:p-2 z-40">
        ...
        {/* Links da navbar */}
        <ul
          className={`flex gap-8 list-none text-white font-medium text-lg sm:flex-col sm:w-full sm:overflow-hidden sm:transition-[max-height] sm:duration-300 ${
